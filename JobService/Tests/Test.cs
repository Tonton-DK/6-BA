...
public class Test
{
    ...
    {
        var input1 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("156be3a6-5537-41f8-9608-705c7cd7cbc3"), "name", "description"), new Address("road", "2", "5000"), Guid.NewGuid());
        var input2 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("0ebbe367-300a-4c86-9070-d6e106d7e4b9"), "name", "description"), new Address("road", "2", "5000"), Guid.NewGuid());
        var input3 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("62507ed1-e247-4fb1-bbf8-0a73479cc911"), "name", "description"), new Address("road", "2", "5000"), Guid.NewGuid());
    ...
    {
        var input1 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("156be3a6-5537-41f8-9608-705c7cd7cbc3"), "name", "description"), new Address("road", "2", "5000"), Guid.NewGuid());
        var input2 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("0ebbe367-300a-4c86-9070-d6e106d7e4b9"), "name", "description"), new Address("road", "2", "5000"), input1.ClientId);
        var input3 = new Job(Guid.NewGuid(), "title", "description", DateTime.Now, new Category(Guid.Parse("62507ed1-e247-4fb1-bbf8-0a73479cc911"), "name", "description"), new Address("road", "2", "5000"), Guid.NewGuid());
